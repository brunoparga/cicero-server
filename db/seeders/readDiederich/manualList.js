...
// These are the words which would otherwise be misclassified, sent into the
...
const pronouns = [
  // Most of these classify as adverbs, a few as verbs because the gloss begins
  // with 'to ' or due to commas splitting the lemma into four parts like verbs
  "cui",
  "egō <ALT: ego>",
  "hic, haec, hoc",
  "ille, illa, illud",
...
function listToObject(list, group) {
  return list.reduce((object, word) => ({ ...object, [word]: group }), {});
}

// Object that informs the classifier function of where to put each of these
// 'hard' words
module.exports = {
  ...twoPartsOfSpeech,
